...
public class BottomSheet extends Dialog {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                if (navBarColorKey != null) {
                    backgroundPaint.setColor(Theme.getChatColor(navBarColorKey));
                } else {
            ...
            if (containerView.getTranslationY() < 0) {
                backgroundPaint.setColor(behindKeyboardColorKey != null ? Theme.getChatColor(behindKeyboardColorKey) : behindKeyboardColor);
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, int type) {
            ...
            if (type == 0) {
                ...
                textView.setGravity(Gravity.CENTER);
                textView.setTextColor(Theme.getChatColor(Theme.key_featuredStickers_buttonText));
                textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
                textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
                textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.dp(4), Theme.getChatColor(Theme.key_featuredStickers_addButton), Theme.getChatColor(Theme.key_featuredStickers_addButtonPressed)));
    ...
    public BottomSheet(Context context, boolean needFocus) {
        ...
        shadowDrawable.setColorFilter(new PorterDuffColorFilter(Theme.getChatColor(Theme.key_dialogBackground), PorterDuff.Mode.MULTIPLY));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (title != null) {
            ...
            if (bigTitle) {
                titleView.setTextColor(Theme.getChatColor(Theme.key_dialogTextBlack));
                ...
                titleView.setTextColor(Theme.getChatColor(Theme.key_dialogTextGray2));
