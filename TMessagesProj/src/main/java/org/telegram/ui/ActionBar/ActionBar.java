...
public class ActionBar extends FrameLayout {
    ...
    private void createSubtitleTextView() {
        ...
        subtitleTextView.setTextColor(Theme.getColor(Theme.key_actionBarDefaultSubtitle, Theme.CHAT_MASK));
    ...
    public void createAdditionalSubtitleTextView() {
        ...
        additionalSubtitleTextView.setTextColor(Theme.getColor(Theme.key_actionBarDefaultSubtitle, Theme.CHAT_MASK));
    ...
    private void createTitleTextView(int i) {
        ...
        if (titleColorToSet != 0) {
            ...
            titleTextView[i].setTextColor(Theme.getColor(Theme.key_actionBarDefaultTitle, Theme.CHAT_MASK));
        }
    ...
    public ActionBarMenu createActionMode(boolean needTop, String tag) {
        ...
        actionMode.setBackgroundColor(Theme.getColor(Theme.key_actionBarActionModeDefault, Theme.CHAT_MASK));
        ...
        if (occupyStatusBar && needTop && actionModeTop == null) {
            ...
            actionModeTop.setBackgroundColor(Theme.getColor(Theme.key_actionBarActionModeDefaultTop, Theme.CHAT_MASK));
